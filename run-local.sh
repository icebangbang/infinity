...
docker run -d --privileged=true  -e "profiles=test" --name=dao-celery-5 -e "index=5" -e "route=day_level" -e "FLASK_ENV=test" -e "thread=50" --net=host --rm -it dao-celery:latest
